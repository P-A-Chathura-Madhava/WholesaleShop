...
public class AdminPromotionController {
	...
	void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
		...
		col_item_product_id.setStyle("-fx-font-size: 14");
		col_item_product_name.setStyle("-fx-font-size: 14");
		col_item_percentage.setStyle("-fx-font-size: 14");
		col_item_more.setStyle("-fx-font-size: 14");
