...
public class AdminCustomerController {
	...
	void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
		...
		col_item_card_no.setStyle("-fx-font-size: 14");
		col_item_amount.setStyle("-fx-font-size: 14");
		col_item_last_date_used.setStyle("-fx-font-size: 14");
		col_item_expired_date.setStyle("-fx-font-size: 14");
		col_item_date_created.setStyle("-fx-font-size: 14");
		col_item_pin.setStyle("-fx-font-size: 14");
