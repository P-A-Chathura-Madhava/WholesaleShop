...
public class AdminCardController {
	...
	void initialize() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
		...
		col_item_customer.setStyle("-fx-font-size: 14");
		col_item_lastused_date.setStyle("-fx-font-size: 14");
		col_item_registerdate.setStyle("-fx-font-size: 14");
		col_item_expiredate.setStyle("-fx-font-size: 14");
