...
public class AdminCashierController {
    ...
    void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
        ...
        col_item_addr.setMinWidth(100.0);
        col_item_phone.setMinWidth(100.0);
        col_item_email.setMinWidth(150.0);
        col_item_password.setMinWidth(60.0);
        col_item_date_created.setMinWidth(80.0);
        
        col_item_id.setStyle("-fx-font-size: 14");
        col_item_name.setStyle("-fx-font-size: 14");
        col_item_age.setStyle("-fx-font-size: 14");
        col_item_gender.setStyle("-fx-font-size: 14");
        col_item_addr.setStyle("-fx-font-size: 14");
        col_item_phone.setStyle("-fx-font-size: 14");
        col_item_email.setStyle("-fx-font-size: 14");
        col_item_password.setStyle("-fx-font-size: 14");
        col_item_date_created.setStyle("-fx-font-size: 14");
		...
		tb_cashier.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
			if(newValue != null){
	...
	private void setCustomerData(Cashier newValue) {
